        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="booking-form">
                    <li><input type="text" class="form-control" placeholder="Enter Your Name" /><i class="fas fa-user"></i></li>
                    <li><input type="text" class="form-control" placeholder="Select Your Location" /><i class="fas fa-map-marker-alt"></i></li>
                    <li>
                ...
                <div class="about-video_block">
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            <a href="{{url('https://www.youtube.com/watch?v=pBFQdxA-apI')}}" class="video-play-img popup-youtube">
                                <img src="{{asset('images/about-img.jpg')}}" class="img-fluid w-100" alt="#" />
