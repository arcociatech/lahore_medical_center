    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="{{url('index-2.html')}}" class="nav-link"> CORK </a>
            </li>
        ...
        <ul class="navbar-item flex-row navbar-dropdown">
            <li class="nav-item dropdown language-dropdown more-dropdown">
                <div class="dropdown  custom-dropdown-icon">
                    ...
                    <div class="dropdown-menu dropdown-menu-right animated fadeInUp" aria-labelledby="langDropdown">
                        ...
                        <a class="dropdown-item" data-img-value="fr" data-value="French" href="{{url('javascript:void(0);')}}"><img src="{{asset('assets/img/fr.png')}}" class="flag-width" alt="flag"> French</a>
                        <a class="dropdown-item" data-img-value="ca" data-value="English" href="{{url('javascript:void(0);')}}"><img src="{{asset('assets/img/ca.png')}}" class="flag-width" alt="flag"> English</a>
                    </div>
                </div>
            </li>

            <li class="nav-item dropdown message-dropdown">
                <a href="{{url('javascript:void(0);')}}" class="nav-link dropdown-toggle" id="messageDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <li class="nav-item dropdown notification-dropdown">
                <a href="{{url('javascript:void(0);')}}" class="nav-link dropdown-toggle" id="notificationDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                <a href="{{url('javascript:void(0);')}}" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
